...
![Reviewer UI — grouped sections in the sidebar, an architect review flag, the selected group's diff with an inline reviewer comment, and the submit bar](docs/screenshot.png?v=3)
